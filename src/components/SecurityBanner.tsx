  ...
  return (
    <div className="bg-amber-500/8 border border-amber-500/20 rounded-lg mb-4 overflow-hidden transition-all">
      <div className="flex items-center gap-2 px-3 py-2">
        <TriangleAlert className="h-[18px] w-[18px] text-amber-700 dark:text-amber-300 shrink-0" strokeWidth={2.4} />
        ...
        <button
          ...
          className="text-[10px] text-amber-800 hover:text-amber-950 dark:text-amber-300 dark:hover:text-amber-100 shrink-0"
        ...
        <button
          ...
          className="text-amber-800 hover:text-amber-950 dark:text-amber-300 dark:hover:text-amber-100 shrink-0 ml-1"
      ...
      {expanded && (
        <div id="security-banner-details" className="px-3 pb-2.5 text-[11px] text-amber-900 dark:text-amber-200 leading-relaxed border-t border-amber-500/10 pt-2">
...
export function InlineWarning({ children }: { children: React.ReactNode }) {
  return (
    <div className="bg-red-500/10 border border-red-500/20 rounded-md px-3 py-2 text-xs text-red-800 dark:text-red-300 flex items-start gap-2">
