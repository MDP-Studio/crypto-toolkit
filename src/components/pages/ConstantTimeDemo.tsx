  ...
  return (
    <div className="space-y-4">
      ...
      <div className="rounded-lg border bg-muted/30 p-4 text-xs text-muted-foreground space-y-2">
        ...
        <p><strong>The elephant in the room:</strong> this entire site uses JavaScript BigInt for RSA, Diffie-Hellman, and elliptic curve operations. BigInt arithmetic is <em>not</em> constant-time — operation duration is proportional to operand size, leaking information about secret exponents and scalars. The Montgomery ladder page demonstrates the <em>algorithmic</em> defense (same operations per bit), but BigInt defeats the guarantee at the implementation level. This is a fundamental limitation of teaching cryptography in a browser, and exactly why production systems use native libraries with constant-time field arithmetic.</p>
      </div>
    </div>
  );
}
